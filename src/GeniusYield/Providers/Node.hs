...
nodeGetProtocolParameters GYAlonzo  info =
  Api.fromLedgerPParams Api.ShelleyBasedEraAlonzo
    <$> queryAlonzoEra info Api.QueryProtocolParameters
nodeGetProtocolParameters GYBabbage info =
  Api.fromLedgerPParams Api.ShelleyBasedEraBabbage
